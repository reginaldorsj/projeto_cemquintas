...
namespace CemQuintas.DAO
{
	...
	/// </summary>
	public class RacaDAO : BaseDAO<Raca, long>, CemQuintas.DAO.IRacaDAO
	{
		/// <summary>
		/// Inicializa uma instância da classe <see cref="RacaDAO"/>.
		/// </summary>
		...
		/// <summary>
		/// Inicializa uma instância de <see cref="RacaDAO"/>.
		/// </summary>
