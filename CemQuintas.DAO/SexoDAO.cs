...
namespace CemQuintas.DAO
{
	...
	/// </summary>
	public class SexoDAO : BaseDAO<Sexo, long>, CemQuintas.DAO.ISexoDAO
	{
		/// <summary>
		/// Inicializa uma instância da classe <see cref="SexoDAO"/>.
		/// </summary>
		...
		/// <summary>
		/// Inicializa uma instância de <see cref="SexoDAO"/>.
		/// </summary>
